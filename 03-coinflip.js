...
In this part of the assignment you will explore what you’ve learned so far about variables, prompts, conditionals, operators, 
math, and more to create a “coin flip game”.To complete the game follow the steps outlined below:
...
document.write("The Coin Flip Game");
const rndInt = Math.floor(Math.random() * 10) + 1; // random number between 1 and 10
//document.write(rndInt);
let flipH,flipT
let coinFlip = rndInt;
//document.write(coinFlip);
let choice = prompt("Enter Head or Tail").toLowerCase();
//document.write("head/tail:"+choice)
if (coinFlip < 5)
    flipH = "head";
else if (coinFlip <= 10)
    flipT = "tail"
//document.write(flipH);
//document.write(flipT);
if (choice === flipH)
    alert("The flip was heads and you chose heads...you win!");
else if (choice === flipT)
    alert("The flip was tails and you chose tails...you win!");
else if (flipH === "head" && choice === "tail")
    alert("The flip was heads but you chose tails...you lose!");
else if (flipT === "tail" && choice === "head")
    alert("The flip was tails but you chose head...you lose!")
